class Course:
    ...
    def to_json(self, url, domain_url, element_url):
        return {'id': self.id, 'title': self.title, 'theory_hours': self.theory_hours, 'lab_hours': self.lab_hours, 'work_hours': self.work_hours, 'description': self.description, 'domain_id': self.domain_id, 'term_id': self.term_id, 'url':url, 'domain_url':domain_url, 'element_url':element_url}
